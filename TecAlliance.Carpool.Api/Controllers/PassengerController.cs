...
namespace TecAlliance.Carpool.Api.Controllers
{
    ...
    public class PassengerController : ControllerBase
    {
        ...
        {
            passengerBusinessService.AddDriver(driverDto);
            return StatusCode(200, "Successfully created new Passanger");
            //CreatedAtActtion 
        }
        /// <summary>
        ...
        public async Task<ActionResult<PassengerDto>> Delete()
        {
            ...
            return StatusCode(200, "All passangers were deleted successfully");
        }
        /// <summary>
        ...
        public async Task<ActionResult<PassengerDto>> DeleteById(int Id)
        {
            ...
            return StatusCode(200, $"The user with the ID: {Id} was deleted successfully.");
        }
    }
}