...
namespace TecAlliance.Carpool.Api.Controllers
{
    ...
    public class CarpoolController : ControllerBase
    {
        ...
        public async Task<ActionResult<CarpoolDto>> Delete()
        {
            ...
            return StatusCode(200, "All carpools have been deleted successfully.");
        }
        /// <summary>
        ...
        public async Task<ActionResult<CarpoolDto>> DeleteById(int Id)
        {
            ...
            return StatusCode(200, $"Carpool (Id): {Id} was deleted successfully");
        }
        /// <summary>
        ...
        public async Task<ActionResult<CarpoolDto>> PutByIdJoin(int carpoolId, int userId)
        {
            ...
            return StatusCode(200, $"Successfully added User (Id): {userId} to Carpool (Id) {carpoolId}");
        }
        /// <summary>
        ...
        public  async Task<ActionResult<CarpoolDto>> PutByIdLeave(int carpoolId, int userId)
        {
            ...
            return StatusCode(200, $"Successfully removed User (Id): {userId} from Carpool (Id) {carpoolId}");
        }
        /// <summary>
